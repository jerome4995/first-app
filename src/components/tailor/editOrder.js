...
const EditOrder = () => {
  ...
  const { name, phoneNumber, oStatus, dDate, nPant, nShirt, age, emailId, address, pHeight, pHip, pHipDown, pThighTight, pThighLoose, pKneeHeight, pKneeLoose, pBottom, pPlay, sHeight, sBodySqu, sStomachSqu, sSeat, sShoulder, sHandLength, sKappu, sElbowLoose, sCollar, sSideLoose } = orderDetails;
    ...
    return (
        <div className="container" style={{marginTop:"12px"}}>
            ...
            <Card.Header>
                ...
                <h5 style={{textAlign:"center", marginTop:"-27px"}}>Edit Order</h5>
                </Row>
            </Card.Header>        <Row>
          <Col md="12">
            <Card className="card-user">
              <CardBody>
                <Form>
                  ...
                  <Row className="pb-3 pl-3 pr-3">
                    ...
                    <div className="ui form">
                      <div className="inline field">
                        ...
                        <input type="text" value={nPant} name='nPant' onChange={onChangeHandler}/>
                      </div>
                    </div>
                    </Col>
                  </Row>
                  ...
                  <Row className="pb-3 pl-3 pr-3">
                    ...
                    <div className="ui form">
                      <div className="inline field">
                        ...
                        <input type="text" value={nShirt} name='nShirt' onChange={onChangeHandler}/>
                      </div>
                    </div>
                    </Col>
                  </Row>
                  ...
                  <Col md="4">
                    <div className="ui form">
                      <div className="inline field">
                        ...
                        <input type="date" value={dDate} name='dDate' onChange={onChangeHandler}/>
                      </div>
                    </div>
                    </Col>
                    <Col md="5">
                  ...
                  <button className="ui teal button" onClick={onSubmit}>Update Order</button>
                  </div>
                  </Row>
                </Form>
              </CardBody>
